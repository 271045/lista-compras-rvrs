...
# 1. Configuração da Página (Seu original)
st.set_page_config(page_title="🛒Lista Compras ®rvrs", layout="wide", initial_sidebar_state="collapsed")

# 2. Conexão (Formato Direto)
conn = None
try:
    # Esta linha força o Streamlit a ler os segredos como um dicionário limpo
...
# --- Categorias (Sua lista completa original) ---
