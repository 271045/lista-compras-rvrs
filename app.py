...
# --- CONEXÃO BLINDADA (Lendo Base64) ---
conn = None
try:
    # Lendo a chave codificada dos secrets para evitar erro de PEM
    b64_key = st.secrets["connections"]["gsheets"]["private_key_b64"]
...
# 2. Suas Funções e Categorias Originais (SEM ALTERAÇÕES)
